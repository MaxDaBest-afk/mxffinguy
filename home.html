...
.header {
  ...
  font-size: 40px;
  text-align: center;
  background-image: url('https://catwithmonocle.com/wp-content/uploads/2020/03/ac-new-horizons-nook-pattern-3840x2160-1.jpg');
  border-radius: 25px;
}
...
.card {
  background-image: url('https://catwithmonocle.com/wp-content/uploads/2020/03/ac-new-horizons-leaf-pattern-v2-1920x1200-1.jpg');
  padding: 20px;
  margin-top: 20px;
  border-radius: 25px;
}
...
<div class="row">
  ...
  <div class="rightcolumn">
    ...
    <div class="card">
      ...
      <div class="fakeimg"><a href="https://yuexr.github.io/acnh/moveout.html" target="_blank">Moveout Guide</a></div><br>
